...
class NotificationCompatJellybean
{
  ...
  public static NotificationCompat.Action readAction(int paramInt, CharSequence paramCharSequence, PendingIntent paramPendingIntent, Bundle paramBundle)
  {
    ...
    if (paramBundle != null)
    {
      localObject1 = fromBundleArray(getBundleArrayFromBundle(paramBundle, "android.support.remoteInputs"));
      ...
      localObject2 = localObject1;
      localObject1 = arrayOfRemoteInput;
    }
    else
    {
      localObject2 = null;
    ...
    return new NotificationCompat.Action(paramInt, paramCharSequence, paramPendingIntent, paramBundle, (RemoteInput[])localObject2, (RemoteInput[])localObject1, bool, 0, true, false);
  }
...
/* Location:              C:\Users\Ria\Documents\slope apk\dex-tools-v2.4\classes-dex2jar.jar!\androidx\core\app\NotificationCompatJellybean.class
