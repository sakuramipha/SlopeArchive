...
public abstract class SharedElementCallback
{
  ...
  public Parcelable onCaptureSharedElementSnapshot(View paramView, Matrix paramMatrix, RectF paramRectF)
  {
    if ((paramView instanceof ImageView))
    {
      ...
      Drawable localDrawable = ((ImageView)localObject1).getDrawable();
      localObject2 = ((ImageView)localObject1).getBackground();
      if ((localDrawable != null) && (localObject2 == null))
      {
        localObject2 = createDrawableBitmap(localDrawable);
...
/* Location:              C:\Users\Ria\Documents\slope apk\dex-tools-v2.4\classes-dex2jar.jar!\androidx\core\app\SharedElementCallback.class
