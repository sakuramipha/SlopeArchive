...
class FindAddress
{
  ...
  private static boolean checkHouseNumber(String paramString)
  {
    int k = 0;
    int j;
    for (int i = 0; k < paramString.length(); i = j)
    {
      j = i;
    ...
    if (paramString.find())
    {
      j = Integer.parseInt(paramString.group(1));
      if (j == 0) {
        return false;
      }
...
/* Location:              C:\Users\Ria\Documents\slope apk\dex-tools-v2.4\classes-dex2jar.jar!\androidx\core\tex\\util\FindAddress.class
