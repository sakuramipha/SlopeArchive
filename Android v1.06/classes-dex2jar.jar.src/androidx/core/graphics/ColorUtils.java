...
public final class ColorUtils
{
  ...
  public static void RGBToHSL(int paramInt1, int paramInt2, int paramInt3, float[] paramArrayOfFloat)
  {
    ...
    float f7 = paramInt3 / 255.0F;
    float f5 = Math.max(f6, Math.max(f3, f7));
    float f1 = Math.min(f6, Math.min(f3, f7));
    float f2 = f5 - f1;
    float f4 = (f5 + f1) / 2.0F;
    if (f5 == f1)
    {
  ...
  public static int blendARGB(int paramInt1, int paramInt2, float paramFloat)
  {
    ...
    float f1 = Color.green(paramInt1);
    float f6 = Color.green(paramInt2);
    float f3 = Color.blue(paramInt1);
    float f8 = Color.blue(paramInt2);
    return Color.argb((int)(f2 * f4 + f7 * paramFloat), (int)(f5 * f4 + f9 * paramFloat), (int)(f1 * f4 + f6 * paramFloat), (int)(f3 * f4 + f8 * paramFloat));
  }
  ...
  public static Color compositeColors(Color paramColor1, Color paramColor2)
  {
    if (Objects.equals(paramColor1.getModel(), paramColor2.getModel()))
    {
      ...
      localObject = paramColor2.getComponents();
      ...
      for (int i = 0; i < j; i++) {
        localObject[i] = (arrayOfFloat[i] * f1 + localObject[i] * f2);
      }
      return Color.valueOf((float[])localObject, paramColor2.getColorSpace());
    }
...
/* Location:              C:\Users\Ria\Documents\slope apk\dex-tools-v2.4\classes-dex2jar.jar!\androidx\core\graphics\ColorUtils.class
