  ...
  void updateDstRect()
  {
    if (this.mApplyGravity)
    {
      if (this.mIsCircular)
      {
        ...
        int k = Math.max(0, (this.mDstRect.width() - i) / 2);
        int j = Math.max(0, (this.mDstRect.height() - i) / 2);
        this.mDstRect.inset(k, j);
...
/* Location:              C:\Users\Ria\Documents\slope apk\dex-tools-v2.4\classes-dex2jar.jar!\androidx\core\graphics\drawable\RoundedBitmapDrawable.class
