...
public final class R
{
  ...
  public static final class drawable
  {
    ...
    public static final int ic_launcher = 2131034136;
    public static final int notification_action_background = 2131034137;
    public static final int notification_bg = 2131034138;
    public static final int notification_bg_low = 2131034139;
    public static final int notification_bg_low_normal = 2131034140;
    public static final int notification_bg_low_pressed = 2131034141;
    public static final int notification_bg_normal = 2131034142;
    public static final int notification_bg_normal_pressed = 2131034143;
    public static final int notification_icon_background = 2131034144;
    public static final int notification_template_icon_bg = 2131034145;
    public static final int notification_template_icon_low_bg = 2131034146;
    public static final int notification_tile_bg = 2131034147;
    public static final int notify_panel_notification_icon_bg = 2131034148;
  }
  ...
  public static final class id
  {
    ...
    public static final int layout = 2131099716;
    public static final int left = 2131099717;
    public static final int light = 2131099718;
    public static final int line1 = 2131099719;
    public static final int line3 = 2131099720;
    public static final int none = 2131099721;
    public static final int normal = 2131099722;
    public static final int notification_background = 2131099723;
    public static final int notification_main_column = 2131099724;
    public static final int notification_main_column_container = 2131099725;
    public static final int right = 2131099726;
    public static final int right_icon = 2131099727;
    public static final int right_side = 2131099728;
    public static final int standard = 2131099729;
    public static final int start = 2131099730;
    public static final int tag_accessibility_actions = 2131099731;
    public static final int tag_accessibility_clickable_spans = 2131099732;
    public static final int tag_accessibility_heading = 2131099733;
    public static final int tag_accessibility_pane_title = 2131099734;
    public static final int tag_on_apply_window_listener = 2131099735;
    public static final int tag_on_receive_content_listener = 2131099736;
    public static final int tag_on_receive_content_mime_types = 2131099737;
    public static final int tag_screen_reader_focusable = 2131099738;
    public static final int tag_state_description = 2131099739;
    public static final int tag_transition_group = 2131099740;
    public static final int tag_unhandled_key_event_manager = 2131099741;
    public static final int tag_unhandled_key_listeners = 2131099742;
    public static final int tag_window_insets_animation_callback = 2131099743;
    public static final int text = 2131099744;
    public static final int text2 = 2131099745;
    public static final int time = 2131099746;
    public static final int title = 2131099747;
    public static final int top = 2131099748;
    public static final int unitySurfaceView = 2131099749;
  ...
  {
    public static final int admob_empty_layout = 2131230720;
    public static final int browser_actions_context_menu_page = 2131230721;
    public static final int browser_actions_context_menu_row = 2131230722;
    public static final int custom_dialog = 2131230723;
    public static final int notification_action = 2131230724;
    public static final int notification_action_tombstone = 2131230725;
    public static final int notification_template_custom_big = 2131230726;
    public static final int notification_template_icon_group = 2131230727;
    public static final int notification_template_part_chronometer = 2131230728;
    public static final int notification_template_part_time = 2131230729;
  }
  ...
  public static final class string
  {
    ...
    public static final int native_body = 2131361822;
    public static final int native_headline = 2131361823;
    public static final int native_media_view = 2131361824;
    public static final int notifications_permission_confirm = 2131361825;
    public static final int notifications_permission_decline = 2131361826;
    public static final int notifications_permission_title = 2131361827;
    public static final int offline_notification_text = 2131361828;
    public static final int offline_notification_title = 2131361829;
    public static final int offline_opt_in_confirm = 2131361830;
    public static final int offline_opt_in_confirmation = 2131361831;
    public static final int offline_opt_in_decline = 2131361832;
    public static final int offline_opt_in_message = 2131361833;
    public static final int offline_opt_in_title = 2131361834;
    public static final int play_games_sdk_version = 2131361835;
    public static final int s1 = 2131361836;
    public static final int s2 = 2131361837;
    public static final int s3 = 2131361838;
    public static final int s4 = 2131361839;
    public static final int s5 = 2131361840;
    public static final int s6 = 2131361841;
    public static final int s7 = 2131361842;
    public static final int status_bar_notification_info_overflow = 2131361843;
    public static final int watermark_label_prefix = 2131361844;
  }
  ...
  public static final class style
  {
    ...
    public static final int BaseUnityTheme = 2131427330;
    ...
    public static final int Theme_Games_Transparent = 2131427336;
    public static final int Theme_IAPTheme = 2131427337;
    public static final int UnityThemeSelector = 2131427338;
    public static final int UnityThemeSelector_Translucent = 2131427339;
  ...
  public static final class styleable
  {
    ...
    public static final int[] Capability = { 2130771997, 2130771999 };
    public static final int Capability_queryPatterns = 0;
    public static final int Capability_shortcutMatchRequired = 1;
    public static final int[] ColorStateListItem = { 16843173, 16843551, 2130771971 };
    public static final int ColorStateListItem_alpha = 2;
    public static final int ColorStateListItem_android_alpha = 1;
    public static final int ColorStateListItem_android_color = 0;
    public static final int[] CoordinatorLayout = { 2130771989, 2130772000 };
    public static final int[] CoordinatorLayout_Layout = { 16842931, 2130771990, 2130771991, 2130771992, 2130771993, 2130771994, 2130771995 };
    ...
    public static final int[] FontFamily = { 2130771977, 2130771978, 2130771979, 2130771980, 2130771981, 2130771982, 2130771983 };
    public static final int[] FontFamilyFont = { 16844082, 16844083, 16844095, 16844143, 16844144, 2130771976, 2130771984, 2130771985, 2130771986, 2130772001 };
    ...
    public static final int[] LoadingImageView = { 2130771973, 2130771987, 2130771988 };
    public static final int LoadingImageView_circleCrop = 0;
    public static final int LoadingImageView_imageAspectRatio = 1;
    public static final int LoadingImageView_imageAspectRatioAdjust = 2;
    public static final int[] SignInButton = { 2130771972, 2130771974, 2130771998 };
...
/* Location:              C:\Users\Ria\Documents\slope apk\dex-tools-v2.4\classes-dex2jar.jar!\com\y8\slope\R.class
